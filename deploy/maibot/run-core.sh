...
: "${MAIBOT_PUBLISH_SPEC:?Set MAIBOT_PUBLISH_SPEC for this launch}"
...
printf 'started %s with publish spec %s using %s\n' \
  "$CONTAINER_NAME" "$MAIBOT_PUBLISH_SPEC" "$MAIBOT_IMAGE"
