...
from window_chrome import FramelessResizeMixin
...
class ChatPanel(FramelessResizeMixin, QWidget):
    ...
    def _build_toolbar(self, layout) -> None:
        """标题行（拖动/最大化手柄）+ 问候标签。"""
        title = QLabel("🤖 Personal AI Assistant v5.2")
    ...
    def _build_input_area(self, layout) -> None:
        """快捷按钮行 + 附件状态 + 输入行。"""
