...
def test_chat_marks_knowledge_entity_and_healer_material_as_untrusted(
    ...
    monkeypatch.setattr("app.novel.entities.build_entity_context", lambda message: malicious)
    monkeypatch.setattr("app.fitness.service.get_fitness_facts", lambda message: [])
    monkeypatch.setattr(
